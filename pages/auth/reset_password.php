    ...
    <section style="padding: 40px 0;">
        <div class="gilded-container">
            <div class="gilded-header">
                ...
                <p class="gilded-subtitle">Create a new passcode</p>
            </div>
            <form method="post" class="gilded-form">
                ...
                <button type="submit" class="gilded-btn">UPDATE PASSCODE <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14"></path><path d="M12 5l7 7-7 7"></path></svg></button>
            </form>

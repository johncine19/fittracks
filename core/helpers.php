...
function nav_icon(string $key): string
{
    $icons = [
        ...
        // Leaf / apple — My diet / nutrition
        'my_diet' => '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a10 10 0 0 1 10 10"/><path d="M2 12C2 6.48 6.48 2 12 2"/><path d="M12 22C6.48 22 2 17.52 2 12"/><path d="M22 12c0 5.52-4.48 10-10 10"/><path d="M12 8v8"/><path d="M8 12h8"/></svg>',
